...
- Always document non-obvious logic changes with comments. Focus on the "why" rather than the "what"—explain hidden constraints, subtle invariants, workarounds, or non-standard patterns.
